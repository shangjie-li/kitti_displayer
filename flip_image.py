...
if __name__ == '__main__':
    ...
    files_of_png = glob.glob(os.path.join(args.input_folder, '*.png'))
    files_of_jpg = glob.glob(os.path.join(args.input_folder, '*.jpg'))
    files_of_jpeg = glob.glob(os.path.join(args.input_folder, '*.jpeg'))
    ...
    for idx in range(num):
        ...
        cv2.imwrite(os.path.join(args.output_folder, input_name), img)
